...
//         _p = remainder; // TODO: parse and set malloc or mmap here - ruiamzn
//         return true;
//       }
//     }
//     return false;
...
// void MallocLimitSet::set_global_limit(size_t s, NMemLimitMode flag) {
//   _glob.sz = s; _glob.mode = flag;
// }

// void MallocLimitSet::set_category_limit(MemTag mem_tag, size_t s, NMemLimitMode flag) {
...
// bool MallocLimitSet::parse_n_mem_limit_option(const char* v, const char** err) {
...
// void MallocLimitHandler::initialize(const char* malocLimit) {
//   _have_limit = false;
//   if (options != nullptr && options[0] != '\0') {
//     const char* err = nullptr;
//     if (!_limits.parse_n_mem_limit_option(options, &err)) {
